...
function encodeMsg(str, encoding) {
	encoding = encoding || defs.encodings.detect(str);
	exports.log.silly('Encoding Message: ' + encoding);
...
function objToPdu(obj, cb) {
	...
	if (obj.params.short_message !== undefined && ! Buffer.isBuffer(obj.params.short_message)) {
		...
		obj.params.short_message	= encodeMsg(obj.params.short_message, obj.params.data_coding);
